...
# Azure IWES is based on the azure theme by rdbende.
# Changed blue color to match corporate identity of Leibniz Universitaet Hannover.
# Added multi colored Switch styles for Checkbutton
...
namespace eval ttk::theme::azure {
    ...
    ttk::style theme create azure -parent default -settings {
        ...
        ttk::style layout Switch_blue {
            Switch.button -children {
                Switch.padding -children {
                    Switch_blue.indicator -side left
                    Switch.label -side right -expand true
                }
            }
        }

        ttk::style layout Switch_green {
            Switch.button -children {
                Switch.padding -children {
                    Switch_green.indicator -side left
                    Switch.label -side right -expand true
                }
            }
        }

        ttk::style layout Switch_red {
            Switch.button -children {
                Switch.padding -children {
                    Switch_red.indicator -side left
                    Switch.label -side right -expand true
                }
            }
        }

        ttk::style layout Switch_orange {
            Switch.button -children {
                Switch.padding -children {
                    Switch_orange.indicator -side left
                    Switch.label -side right -expand true
                }
            }
        }

        ttk::style layout Switch_purple {
            Switch.button -children {
                Switch.padding -children {
                    Switch_purple.indicator -side left
                    Switch.label -side right -expand true
                }
            }
        }

        ttk::style layout Switch_aqua {
            Switch.button -children {
                Switch.padding -children {
                    Switch_aqua.indicator -side left
                    Switch.label -side right -expand true
                }
            }
        }
        ...
        # Blue Switch
        ttk::style element create Switch_blue.indicator image \
            [list $I(switch-off) \
                selected $I(switch-on-blue) \
            ] -width 46 -sticky w

        # Green Switch
        ttk::style element create Switch_green.indicator image \
            [list $I(switch-off) \
                selected $I(switch-on-green) \
            ] -width 46 -sticky w

        # Red Switch
        ttk::style element create Switch_red.indicator image \
            [list $I(switch-off) \
                selected $I(switch-on-red) \
            ] -width 46 -sticky w

        # Red Switch
        ttk::style element create Switch_orange.indicator image \
            [list $I(switch-off) \
                selected $I(switch-on-orange) \
            ] -width 46 -sticky w

        # Red Switch
        ttk::style element create Switch_purple.indicator image \
            [list $I(switch-off) \
                selected $I(switch-on-purple) \
            ] -width 46 -sticky w

        # Red Switch
        ttk::style element create Switch_aqua.indicator image \
            [list $I(switch-off) \
                selected $I(switch-on-aqua) \
            ] -width 46 -sticky w
